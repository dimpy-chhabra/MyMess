 ...
 * @author Dell
 */
public class Urecharge extends javax.swing.JFrame {
...
//2->enrollment no.
    ...
    public Urecharge(String[] SessionArray) {
    ...
    private void initComponents() {
        ...
        jButton9.setText("RECHARGE MY ACCOUNT");
        ...
        jToggleButton1.setText("What's a passcode?");
...
// TODO add your handling code here:
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        String amount, passcode;
        amount = jTextField1.getText();
        passcode = jTextField2.getText();
        
        String[] dbData = new String[4];
        dbData[0] = SessionArray[0];    
        dbData[1] = SessionArray[2];
        dbData[2] = amount;
        dbData[3] = passcode;
        //0->username
        //1->password //not visible
        ...
        String return_array = obj.RechargeGetBal(SessionArray);
        System.out.println(" balance ---> "+return_array);

        int x,y,z;
        x = Integer.valueOf(return_array);
        y = Integer.valueOf(amount);
        z = x + y;
        String[] newbaldata = new String[2];
        newbaldata[0]= SessionArray[2];
        newbaldata[1]= String.valueOf(z);
        int ret = obj.RechargeAccount(newbaldata);
        
        if(ret>0){
            JOptionPane.showMessageDialog(this, "Transaction of Rs."+y+" successful!" );
        }
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        JOptionPane.showMessageDialog(this, "The passcode is the number given by Mess Incharge when he recieves the required amount.");
        // TODO add your handling code here:
