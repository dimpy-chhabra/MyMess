 ...
 * @author Dell
 */
public class AviewuserPrint extends javax.swing.JFrame {
String Data;
    /**
     * Creates new form victim0
     */
    
    public AviewuserPrint(String[] dbData) {
        initComponents();
        Data = dbData[0];
    ...
    private void initComponents() {
        ...
        jLabel3.setText("You are here >> Admin >>View User >> data");
        ...
        jLabel4.setText("USER'S MONEY-ONEY-NEY-EY-Y");

        jButton10.setText("Show USER'S money");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String[] dbDataD = obj.GetDetails(Data);
        //JOptionPane.showMessageDialog(this, " Data is "+dbDataD[1]+" "+dbDataD[2]);
...
DefaultTableModel model = (DefaultTableModel)jTable2.getModel();
        ...
        try {
            ...
            String query_hstry="Select * from user_history WHERE usr_enroll = '"+Data+"';";
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        Adetailsprint obj = new Adetailsprint();
        String[] dbDataD = obj.GetDetails(Data);
        System.out.println("GUIframes.AviewuserPrint.jButton10ActionPerformed() : Data Fetched "+dbDataD[10] + " "+dbDataD[7]);
